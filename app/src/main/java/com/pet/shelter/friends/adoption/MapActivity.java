...
//
//        searchEditText = findViewById(R.id.mapSearch_editText);
...
////        autocompleteSupportFragment = (AutocompleteSupportFragment) getSupportFragmentManager().findFragmentById(R.id.mapAutocomplete_fragment);
//
////        Objects.requireNonNull(autocompleteSupportFragment).setPlaceFields(Arrays.asList(Place.Field.ID,
...
////
////                Log.i(TAG, "onPlaceSelected: lat=" + Objects.requireNonNull(latLng).latitude+"   long=" + Objects.requireNonNull(latLng).longitude);
////            }
////        });
//    }
//
...
////        searchString = autocompleteSupportFragment.getString();
