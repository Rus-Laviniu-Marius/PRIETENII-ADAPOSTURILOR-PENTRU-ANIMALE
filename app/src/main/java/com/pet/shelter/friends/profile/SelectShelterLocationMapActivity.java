...
public class SelectShelterLocationMapActivity extends FragmentActivity implements OnMapReadyCallback {

    private static final String TAG = SelectShelterLocationMapActivity.class.getSimpleName();
    ...
    // not granted.
    private final LatLng defaultLocation = new LatLng(45.760696, 21.226788);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_shelter_location_map);

        constraintLayout = findViewById(R.id.selectShelterLocation_constraintLayout);
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.selectShelterLocation_map);
        if (mapFragment != null) {
